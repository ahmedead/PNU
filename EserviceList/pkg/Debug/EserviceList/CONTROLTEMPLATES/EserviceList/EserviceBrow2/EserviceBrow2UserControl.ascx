...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EserviceBrow2UserControl.ascx.cs" Inherits="EserviceList.EserviceBrow2.EserviceBrow2UserControl" %>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="service-card">
                        <div class="serv-icon">
                            <img src="assets/imgs/logo_small.svg" title="" alt="">
                        </div>
                        <h5> طلب اخلاء طرف </h5>
