...
using Pnu.Internet.CustomTimerJobs.InstructorCourses;
using System;
using System.Runtime.InteropServices;
using System.Security.Permissions;

namespace Pnu.Internet.CustomTimerJobs.Features.Instructor_Courses_Feature
{
    /// <summary>
    ...
    [Guid("fb46349c-3320-4dd0-a240-b7471bd54d5a")]
    public class Instructor_Courses_FeatureEventReceiver : SPFeatureReceiver
    {
        // Uncomment the method below to handle the event raised after a feature has been activated.

        const string JOB_NAME = "InstructorCoursesTimerJob";
        ...
        public override void FeatureActivated(SPFeatureReceiverProperties properties)
        {
            ...
            InstructorCoursesTimerjob customTimerJob = new InstructorCoursesTimerjob(webApp);
