...
using Pnu.Internet.CustomTimerJobs.StudyPlan;
using System;
using System.Runtime.InteropServices;
using System.Security.Permissions;

namespace Pnu.Internet.CustomTimerJobs.Features.Study_Plan_Feature
{
    /// <summary>
    ...
    [Guid("424f59c5-d6c2-48fd-b152-05fa1a9f6825")]
    public class Study_Plan_FeatureEventReceiver : SPFeatureReceiver
    {
        // Uncomment the method below to handle the event raised after a feature has been activated.

        const string JOB_NAME = "StudyPlanTimerJob";
        ...
        public override void FeatureActivated(SPFeatureReceiverProperties properties)
        {
            ...
            StudyPlanTimerJob customTimerJob = new StudyPlanTimerJob(webApp);
