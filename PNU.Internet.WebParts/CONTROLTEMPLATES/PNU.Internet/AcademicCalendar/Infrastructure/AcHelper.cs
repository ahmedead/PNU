...
{
    /// <summary>
    /// Shared helpers for the Academic Calendar controls.
    ...
    public static class AcHelper
    {
        ...
        /// <summary>Standard ordered query used by the Academic Calendar list.</summary>
        ...
        public static List<SPListItem> GetItems(SPWeb web, string listName)
        {
            ...
            {
                AcLog.Write("AcHelper.GetItems:" + listName, ex);
