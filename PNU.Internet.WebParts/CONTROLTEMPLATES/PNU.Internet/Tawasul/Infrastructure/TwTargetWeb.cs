...
{
    /// <summary>
    /// Resolves the web that hosts the Tawasul (تواصل) lists.
    ///
    /// All content lists live on ONE web - /ar/Tawasul - regardless of which web the
    /// page is rendered from, so the Arabic and English pages share a single set of
    /// bilingual items and editors have one place to manage them.
    ///
    /// The caller ALWAYS disposes the returned SPWeb.
    /// </summary>
    public static class TwTargetWeb
    {
        /// <summary>Path of the web holding the content lists.</summary>
        public const string DefaultPath = "/ar/Tawasul";
        ...
        private static SPWeb OpenPath(SPSite site, string path, bool allowFallback)
        {
            ...
            {
                TwLog.Write("TwTargetWeb.OpenFallback", ex);
            }
