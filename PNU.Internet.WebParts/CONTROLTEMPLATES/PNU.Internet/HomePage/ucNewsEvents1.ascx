...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucNewsEvents11.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.HomePage.ucNewsEvents1" %>
...
<section class="news-and-events my-1 py-1  py-md-5 my-md-5 ">
    <div class="container">
        <div class="d-flex justify-content-center align-items-center flex-wrap flex-lg-nowrap mb-5">
            <div class="col-12 col-lg-auto tabbable" style="display: none">
                                        ...
                                        <div>
                                            <p class="mb-0 text-end">
                                                <a href='<%# Eval("AllEventsLink") %>' runat="server" class="btn btn-link fw-bolder text-primary text-decoration-none">
                                                    <asp:Literal runat="server" Text="<%$ Resources: PNUres, AllAdvsLink %>" />
