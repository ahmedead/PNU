...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucHomeAchievements.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.HomePage.DGA.ucHomeAchievements" %>

<%@ Import Namespace="PNU.Internet.WebParts" %>

<section class="gray colored-section py-5" data-aos="fade-up" aria-labelledby="achievements-section-title">
    <div class="container">
        <div class="mb-4">
            <div class="d-flex justify-content-between align-items-center gap-2">
                <h2 id="achievements-section-title" class="mb-0">
                ...
                <div id="divViewMore" runat="server">
                    <a href="AchievementsArchive.aspx" class="btn btn-outline-secondary fw-semibold">
        ...
        <ul class="nav nav-tabs nav-underline nav-flush w-100 mb-4" id="achievementsTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button
                    ...
                    id="achievements-tab" data-bs-toggle="tab" data-bs-target="#achievements-pane" type="button" role="tab"
                    aria-controls="achievements-pane" aria-selected="true">
                    <i class="hgi hgi-stroke hgi-elearning-exchange fs-5 fw-light" aria-hidden="true"></i>
                    <span><SharePoint:EncodedLiteral runat="server" Text="<%$Resources:CommonGlobalResources,Achievements%>" EncodeMethod="HtmlEncode"/></span>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button
                    ...
                    <span><SharePoint:EncodedLiteral runat="server" Text="<%$Resources:CommonGlobalResources,Awards%>" EncodeMethod="HtmlEncode"/></span>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button
                    ...
                    <span><SharePoint:EncodedLiteral runat="server" Text="<%$Resources:CommonGlobalResources,Rankings%>" EncodeMethod="HtmlEncode"/></span>
                </button>
            </li>
        </ul>
                                    ...
                                    <div class="card-body d-flex flex-column h-100">
                                        ...
                                        <div class="mt-auto d-flex flex-column gap-3">
                                            <small class="d-flex gap-2 align-items-center">
                                                ...
                                                <time><%# SPFactory.GetLocalizedTitle(Eval("DisplayDate"), Eval("DisplayDate_EN")) %></time>
                                            </small>
                                        </div>
                                    </div>
                                </article>
