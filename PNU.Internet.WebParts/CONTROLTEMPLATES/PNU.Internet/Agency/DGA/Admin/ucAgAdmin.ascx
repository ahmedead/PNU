...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAgAdmin.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.Agency.DGA.ucAgAdmin, $SharePoint.Project.AssemblyFullName$" %>

<section class="py-5 ag-admin">
    <div class="container">
