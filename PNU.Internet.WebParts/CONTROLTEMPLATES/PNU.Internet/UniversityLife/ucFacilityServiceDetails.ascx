...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucFacilityServiceDetails.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.Centers.ucFacilityServiceDetails" %>
        ...
        <section class=" my-5 p-5 bg-semi-light position-relative">
            <div class="container my-5">
                <h1 class="title text-dark fw-bold px-2 border-start border-primary mb-4 mt-md-0 mt-4"> <asp:Literal ID="lit_otherServices" runat="server" Text="<%$Resources:PnuInternetResources, res_OtherServices%>"></asp:Literal>  
