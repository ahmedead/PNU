...
{
    public partial class ucServiceDatails : UserControl
    {
                ...
                {
                    {
                        using (SPSite site = new SPSite(SPContext.Current.Web.Url))
                        {
                            ...
                            {
                                SPList requestsList = web.Lists["Services"];
                          ...
                          <FieldRef Name='ItemOrder' Ascending='False' />
                                ...
                                <div class='col-12 col-lg-6 mt-0 pb-md-5 pb-2   mb-md-5 mb-2 text-end'>
                                    <div class=' position-relative ms-4 pattern-behind-img'>
                                        ...
                                        <img src='@Image'
                                            class='d-block w-100 rounded-4 object-fit-cover img-fluid ms-auto d-block mx-5'
                                            alt='...'>
                                    </div>
                                </div>";
