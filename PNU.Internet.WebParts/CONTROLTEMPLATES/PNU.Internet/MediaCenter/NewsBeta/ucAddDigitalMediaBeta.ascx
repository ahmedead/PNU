...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAddDigitalMediaBeta.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.NewsBeta.ucAddDigitalMediaBeta" %>
