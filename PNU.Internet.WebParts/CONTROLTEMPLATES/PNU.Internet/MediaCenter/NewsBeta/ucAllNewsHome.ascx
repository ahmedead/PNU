...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAllNewsHome.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.NewsBeta.ucAllNewsHome" %>
                                            ...
                                            <div class="card border rounded-4 h-100">
                                                <div class="card-body p-2">
                                                    ...
                                                    <div class="video-wrapper video-container" 
                                                        style='<%# !string.IsNullOrEmpty(Convert.ToString(Eval("AttachmentURL"))) ? "": "display:none;" %>'>
                                                    ...
                                                    <div style='<%# string.IsNullOrEmpty(Convert.ToString(Eval("AttachmentURL"))) ? "": "display:none;" %>' class="video-wrapper video-container" id="divVideo" runat="server"
                                                        visible='<%# Convert.ToBoolean(Eval("IsVideo")) && Convert.ToBoolean(Eval("IsYouTubeVideo"))  
                                                            && string.IsNullOrEmpty(Convert.ToString(Eval("AttachmentURL")))%>'>
