...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucEditDigitalMedia.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.DigitalMedia.ucEditDigitalMedia" %>
                ...
                <div class="card mb-4 p-5 shadow border-0 rounded-4 ">
                    <div class="row">
                        <div class="col-md-12 text-start">
                            <h4 class="card-title mb-4 fw-bold">نموذج تعديل الوسائط الرقمية </h4>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-4">
                                ...
                                <ul class="list-group">
                                    <asp:DropDownList ID="ddlMediaCategory" CssClass="form-select" runat="server" DataValueField="TitleEn" OnChange="checkMediaCategorySelection()"></asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="rfvCategory" runat="server" Enabled="true" ErrorMessage="required" ValidationGroup="group1"
                                        ControlToValidate="ddlMediaCategory" InitialValue="0" CssClass="required" Style="color: red" Display="dynamic" />
                        ...
                        <div class="col-md-12" id="divImg" runat="server" visible ="false">
                            <div class=" mb-4 ">
                                <div class="input-group mb-4 ">
                                    <asp:HyperLink ID="imgUrl" runat="server" Target="_blank"></asp:HyperLink>
                                </div>
                                <div class="input-group mb-4 ">
                                    <asp:CheckBox ID="chkRemoveImg" Text="حذف الصورة ؟ " runat="server" />
                                </div>
                        ...
                        <asp:HiddenField ID="HiddenFieldFileUrl" runat="server" />


                        <div class="col-md-12" id="divVideo" runat="server" visible ="false">
                            <div class=" mb-4 ">
                                <div class="input-group mb-4 ">
                                    <asp:HyperLink ID="HyperLinkFile" runat="server" Target="_blank"></asp:HyperLink>
                                </div>
                            </div>
                                                            <div class="input-group mb-4 ">
    <asp:CheckBox ID="chkVideo" Text="حذف الفيديو ؟ " runat="server" />
</div>
                        </div>
                        ...
                        <div class="col-md-12" id="divArticle" runat="server" style="display: none">
                            <div class="form-floating mb-4">
                                <asp:Label ID="Label8" runat="server" Text="كاتب المقال"></asp:Label>
                                <asp:TextBox ID="txtPublisherName" runat="server" class="form-control"></asp:TextBox>
                            </div>
                            <div class="form-floating mb-4">
                                <asp:Label ID="Label9" runat="server" Text=" وظيفة كاتب المقال"></asp:Label>
                                <asp:TextBox ID="txtPublisherPosition" runat="server" class="form-control"></asp:TextBox>
                            </div>
                        </div>
...
<script>
    function checkMediaCategorySelection() {
        var ddlMediaCategory = document.getElementById('<%= ddlMediaCategory.ClientID %>');
        var selectedValue = ddlMediaCategory.options[ddlMediaCategory.selectedIndex].value;
        var divArticle = document.getElementById('<%= divArticle.ClientID %>');

        // Show divArticle if selectedValue is "Articles", hide it otherwise
