...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucNewDigitalMediaDetails.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.DigitalMedia.ucNewDigitalMediaDetails" %>
