...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAllDigitalMediaRequests.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.DigitalMedia.ucAllDigitalMediaRequests" %>
...
<section>
    <div class="container pt-5 my-5">
        ...
        <div id="dvAddNew" runat="server" visible="false">
            <a class="btn btn-primary fcc-btn" href="/ar/MediaCenter/News/Pages/AddDigitalMedia.aspx">إضافة وسائط رقمية</a>
        </div>
