...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAddDigitalMedia.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.DigitalMedia.ucAddDigitalMedia" %>
