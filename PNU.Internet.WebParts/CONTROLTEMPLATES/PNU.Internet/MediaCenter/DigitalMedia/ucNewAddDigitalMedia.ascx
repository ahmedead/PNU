...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucNewAddDigitalMedia.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.DigitalMedia.ucNewAddDigitalMedia" %>
                ...
                <div class="card mb-4 p-5 shadow border-0 rounded-4 ">
                    <div class="row">
                        <div class="col-md-12 text-start">
                            <h4 class="card-title mb-4 fw-bold">نموذج اضافة الوسائط الرقمية </h4>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-4">
                       ...
                       <%-- <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-floating mb-4">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Enabled="true" ErrorMessage="required" ValidationGroup="group1"
                                    Style="color: red" ControlToValidate="txtVideoURL" CssClass="required" Display="dynamic" />
                            </div>
                        </div>
