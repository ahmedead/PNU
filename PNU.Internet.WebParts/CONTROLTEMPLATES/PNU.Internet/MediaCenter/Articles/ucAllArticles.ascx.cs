...
namespace PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.Articles
{
    public partial class ucAllArticles : UserControl
    {
        ...
        void LoadArticles()
        {
            ...
            var itemsColl = Helper.LoadListDynamicByCML(SPContext.Current.Web.Url, ListName, qryParam, "ArticleStartDate");
            ...
            foreach (SPListItem item in itemsColl)
            {
                ...
                var degree = item.Properties["Degree"] != null ? item.Properties["Degree"].ToString() : "";
                ...
                {
                    Date = ArticleDate.ToString("dd/MM/yyyy"),
                    ImageUrl = url,
                    Title = Title,
                    Link = Navurl,
