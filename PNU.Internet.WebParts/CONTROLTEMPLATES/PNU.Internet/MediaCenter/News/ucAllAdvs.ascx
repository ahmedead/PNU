...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAllAdvs.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.News.ucAllAdvs" %>
        ...
        <section class="py-5 mb-5">
            <div class="container">
                            ...
                            <ItemTemplate>
                                <div class="tab-pane fade" id='<%# "new" + Eval("ID") + "-tab-pane" %>' role="tabpanel" aria-labelledby='<%# "new" + Eval("ID") + "-tab" %>' tabindex="0">
                                    <div class="row paginated-content">
                                        <asp:Repeater ID="rptNews" runat="server" DataSource='<%# Eval("Advertisements") %>'>
                                            <ItemTemplate>
                ...
                <div class="py-3 d-flex flex-wrap d-md-block">
                    <a href="/ar/Announcements/Pages/AllAnnouncements.aspx" id="ctl00_ctl39_g_5a0721a6_5b24_4452_9d3f_571ba4fcb413_ctl00_AllMCNews" class="btn btn-lg btn-outline-primary  px-5  me-3 mb-3  mb-md-5 flex-fill">أرشيف الإعلانات
