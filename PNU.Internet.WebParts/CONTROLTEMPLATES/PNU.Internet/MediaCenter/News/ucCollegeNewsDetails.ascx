...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucCollegeNewsDetails.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.News.ucCollegeNewsDetails" %>
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb h6">
            <li class="breadcrumb-item"><a href="<%# String.Format("{0}", SPFactory.GetSiteURL()) %>" class="text-decoration-none fw-bold">
                        ...
                        <li class="breadcrumb-item"><a href="<%# String.Format("{0}{1}{2}", SPFactory.GetSiteURL(),"/MediaCenter/Pages/AllNews.aspx?Id=", Eval("CatID")) %>" class="text-decoration-none fw-bold">
...
<div class="d-flex justify-content-center align-items-center flex-wrap flex-lg-nowrap mb-5">
    <div class="py-3 d-flex flex-wrap d-md-block">
        <asp:Button ID="btnViewAll" runat="server" Text="<%$ Resources: PNUres, res_AllNews %>"  CssClass="btn btn-lg btn-outline-primary  px-5  me-3 mb-3  mb-md-5 flex-fill" OnClick="btnViewAll_Click" />
        <%--<a id="AllMCNews" runat="server" class="btn btn-lg btn-outline-primary  px-5  me-3 mb-3  mb-md-5 flex-fill" href="default.aspx">
