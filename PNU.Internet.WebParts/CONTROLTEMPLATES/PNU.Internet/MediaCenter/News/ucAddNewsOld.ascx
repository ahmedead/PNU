...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAddNewsOldOld.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.News.ucAddNewsOld" %>
