...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucNewsHome.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.News.ucNewsHome" %>
                    ...
                    <ItemTemplate>
                        <div class='<%# "tab-pane fade" + Eval("ClassActiveShow") %>' id='<%# "news" + Eval("ID") + "-tab-pane" %>' role="tabpanel" aria-labelledby='<%# "news" + Eval("ID") + "-tab" %>' tabindex="0">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-7 news">
                                                    ...
                                                    <a href='<%#  Eval("DetailsURL")  %>'>
                                                        <div class="row g-0">
                                                            <div class="col-md-5">
                                                                ...
                                                                <span class="badge rounded-pill text-bg-light " style="left: unset"><%# Eval("MediaDate") %></span>
                                                            </div>
                                                            <div class="col-md-7">
                                                                <div class="card-body">
