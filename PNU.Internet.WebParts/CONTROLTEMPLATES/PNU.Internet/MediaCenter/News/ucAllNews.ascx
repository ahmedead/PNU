...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAllNews.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.News.ucAllNews" %>
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-4">
                                            <div class="card border rounded-4 h-100">
                                                <div class="card-body p-2">
                                                    ...
                                                    <div class="mb-2">
                                                        <span class="badge rounded-pill bg-resonant-blue-100 text-secondary">
                                                            <%# SPFactory.GetLocalizedTitle(Eval("FacultyName"), Eval("FacultyName_EN")) %> </span>
                                                    </div>
                                                </div>
                                             </div>
                                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            tabPanes.forEach(tabPane => {
                ...
                const paginationContainer = tabPane.querySelector('.pagination');
