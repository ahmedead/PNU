...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAllCatNews.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.News.ucAllCatNews" %>
