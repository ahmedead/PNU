...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucEditFacultyNews.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.News.sub_News.ucEditFacultyNews" %>
                        ...
                        <div class="col-md-12">
                            <div class="mb-4">
                                ...
                                <ul class="list-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvFaculties" runat="server" Enabled="true" ErrorMessage="required" ValidationGroup="group1"
