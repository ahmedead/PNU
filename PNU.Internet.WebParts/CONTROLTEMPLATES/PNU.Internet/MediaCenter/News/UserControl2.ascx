...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserControl2.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.News.UserControl2" %>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb h6">
                        ...
                        <li class="breadcrumb-item"><a href="<%# String.Format("{0}{1}", SPFactory.GetSiteURL(),"/MediaCenter/Pages/AllNews.aspx") %>" class="text-decoration-none fw-bold">
                         ...
                         <li class="breadcrumb-item"><a href="<%# String.Format("{0}{1}", SPFactory.GetSiteURL(),"/MediaCenter/Pages/AllNews.aspx?Id=") %>" class="text-decoration-none fw-bold">
                            <asp:Literal runat="server" Text="<%# SPFactory.GetLocalizedTitle(Eval("MainCategory"), Eval("MainCategory_EN")) %>" /></a></li>
