...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucEditNewsForModificationForModification.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.News.ucEditNewsForModification" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-4 form-group">
                                <label>التعليق  </label>
                                <asp:TextBox ID="txtComments" Rows="3" TextMode="MultiLine" Height="300" Enabled="false" ValidationGroup="EditRequest" placeholder="كتابة التعليق" CssClass="form-control" runat="server"></asp:TextBox>
