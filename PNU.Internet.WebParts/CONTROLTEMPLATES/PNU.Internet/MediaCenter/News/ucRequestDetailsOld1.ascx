...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucRequestDetailsOld1.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.News.ucRequestDetailsOld1" %>
                ...
                <div class="row " id="dv_userAction" runat="server">
                        <div class="col-md-12">
                            <div class="mb-4 form-group">
                                <label>التعليق  </label>
                                <asp:TextBox ID="txtComments" Rows="3" TextMode="MultiLine" Height="300" placeholder="كتابة التعليق" CssClass="form-control" runat="server"></asp:TextBox>
                    ...
                    <div class="col-md-12" id="divSubmit" runat="server">
                            <div class="mb-4">
                                <div class="form-group">
                                    ...
                                    <asp:Button ID="btnReject" ValidationGroup="RejectRequest" runat="server" Text="رفض" CssClass="btn btn-danger mx-2" OnClick="btnReject_Click" />
