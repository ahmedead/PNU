...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucNewAddNews.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.News.WithoutVideoUpload.ucNewAddNews" %>
