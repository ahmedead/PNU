...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="usAddAdvertisements.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.Advertisements.usAddAdvertisements" %>
                ...
                <div class="card mb-4 p-5 shadow border-0 rounded-4 ">
                    <div class="row">
                        <div class="col-md-12 text-start">
                            <h4 class="card-title mb-4 fw-bold">نموذج اضافة إعلان </h4>
                        </div>
                      
                         <div class="col-md-12" id="dvIsHome" runat="server" visible="false">
                            <div class="mb-4">

                                <label>نشر علي الصفحة الرئيسية</label>
                                <ul class="list-group">
                        ...
                        <div class="col-md-12" id="dvDept" runat="server" visible="false">
                            <div class="mb-4">
                                ...
                                <label>الجهة الطالبة للإعلان</label>
                                <ul class="list-group">
                                    <asp:DropDownList ID="ddlFaculties" CssClass="form-select"   runat="server" DataValueField="TitleEn"></asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="rfvFaculties" runat="server" Enabled="False" ErrorMessage="الحقل مطلوب" ValidationGroup="group1"
                        ...
                        <div class="col-md-12">
                            <div class="form-floating mb-4">
                                <asp:Label ID="Label1" runat="server" Text="عنوان الإعلان باللغة العربية"></asp:Label>
                                <asp:TextBox ID="txtTitle" runat="server" class="form-control" placeholder=" Media Title Arabic"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rvfTitle" runat="server" Enabled="true" ErrorMessage="الحقل مطلوب" ValidationGroup="group1" 
                        ...
                        <div class="col-md-12">
                            <div class="form-floating mb-4">
                                <asp:Label ID="Label2" runat="server" Text="عنوان الإعلان باللغة الإنجليزية (اختياري)"></asp:Label>
                                <asp:TextBox ID="txtTitleEn" runat="server" class="form-control" placeholder=" Media Title English"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"  ErrorMessage="الحقل مطلوب" ValidationGroup="group1" 
                        ...
                        <div class="col-md-12" id="dvContentAr" runat="server">
                            ...
                            <div class="form-floating mb-4">
                                <asp:Label ID="Label5" runat="server" Text="محتوي الإعلان باللغة العربية"></asp:Label>
                                ...
                                <asp:RequiredFieldValidator ID="rvfDetails" runat="server" Enabled="true" ErrorMessage="الحقل مطلوب" ValidationGroup="group1" 
                        ...
                        <div class="col-md-12" id="dvContentEn" runat="server">
                            <div class="form-floating mb-4">
                            <asp:Label ID="Label6" runat="server" Text="محتوي الإعلان باللغة الإنجليزية (اختياري)"></asp:Label>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"  ErrorMessage="الحقل مطلوب" ValidationGroup="group1"  
