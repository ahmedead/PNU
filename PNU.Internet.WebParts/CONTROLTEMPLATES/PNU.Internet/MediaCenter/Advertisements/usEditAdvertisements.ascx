...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="usEditAdvertisements.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.Advertisements.usEditAdvertisements" %>
                ...
                <div class="card mb-4 p-5 shadow border-0 rounded-4 ">
                    <div class="row">
                        <div class="col-md-12 text-start">
                            <h4 class="card-title mb-4 fw-bold">نموذج تعديل إعلان </h4>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-4 form-group">
                                <label>تعليق طلب التعديل  </label>
                                <asp:TextBox ID="txtComments" Rows="3" TextMode="MultiLine" ValidationGroup="EditRequest" Height="300" Enabled="false" placeholder="كتابة التعليق" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
