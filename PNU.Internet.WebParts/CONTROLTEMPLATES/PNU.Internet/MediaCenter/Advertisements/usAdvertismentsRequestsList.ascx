...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="usAdvertismentsRequestsList.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.MediaCenter.Advertisements.usAdvertismentsRequestsList" %>
    ...
    <div class="container py-5 my-3">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb h6">
                ...
                <li class="breadcrumb-item"><a href="#" class="text-decoration-none fw-bold">الإعلانات</a></li>
...
<section>
    <div class="container pt-5 my-5">
        ...
        <div id="dvAddNew" runat="server" visible="false">
            <a class="btn btn-primary fcc-btn" href="AddAdvertisement.aspx">إضافة إعلان جديد</a>
        </div>
                        ...
                        <asp:Repeater ID="rep" runat="server">
                            ...
                            <ItemTemplate>
                                <tr style="height: 25px;">
                                    ...
                                    <td>
                                        <a href="AdsRequestDetails.aspx?RequestId=<%#Eval("ID").ToString()%>">عرض</a>
                                    </td>
