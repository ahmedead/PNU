...
{
    public partial class ucContactUsDGA : UserControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            {
                ContactUsProvisioner.EnsureLists();
            }
        ...
        private Dictionary<string, KeyValuePair<string, string>> _titles;
        ...
        private void LoadTitles()
        {
            ...
            SPSecurity.RunWithElevatedPrivileges(delegate ()
            {
                ...
                {
                    _titles = ContactUsProvisioner.LoadTitles(web);
                }
            });
        }

        private string T(string key, string ar, string en)
        {
            if (_titles != null && _titles.TryGetValue(key, out var v))
            {
                string val = IsArabic ? v.Key : v.Value;
        ...
        private void SetTitles()
        {
            ...
            ltrInfoTitle.Text = T("InfoTitle", "بيانات الموقع والتواصل", "Location and Contact Details");
            ltrDirectoryTitle.Text = T("DirectoryTitle", "دليل التواصل مع مكاتب الكلية", "College Offices Directory");
            ltrThOffice.Text = T("ThOffice", "المكتب", "Office");
            ltrThExtension.Text = T("ThExtension", "التحويلة", "Extension");
            ltrThRoom.Text = T("ThRoom", "رقم المكتب", "Room");
            ltrThEmail.Text = T("ThEmail", "البريد الرسمي", "Email");
            ltrHoursTitle.Text = T("HoursTitle", "ساعات المستفيدين", "Beneficiary Hours");
            ltrThUnit.Text = T("ThUnit", "الوكالة / القسم", "Unit / Department");
            ltrThDay.Text = T("ThDay", "اليوم", "Day");
            ltrThTime.Text = T("ThTime", "الساعة", "Time");
            ltrUnifiedTitle.Text = T("UnifiedTitle", "أو عن طريق نموذج التواصل الموحد", "Or via the unified contact form");
            ltrFormTitle.Text = T("FormTitle", "نموذج التواصل الموحد", "Unified Contact Form");
            ltrFormText.Text = T("FormText",
        ...
        {
            SPList list = web.Lists.TryGetList(ContactUsProvisioner.InfoListName);
        ...
        {
            SPList list = web.Lists.TryGetList(ContactUsProvisioner.DirectoryListName);
        ...
        {
            SPList list = web.Lists.TryGetList(ContactUsProvisioner.HoursListName);
