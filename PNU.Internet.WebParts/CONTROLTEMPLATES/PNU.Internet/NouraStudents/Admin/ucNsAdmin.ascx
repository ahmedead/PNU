...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucNsAdmin.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.NouraStudents.Controls.ucNsAdmin, $SharePoint.Project.AssemblyFullName$" %>

<section class="py-5 ns-admin">
    <div class="container">
