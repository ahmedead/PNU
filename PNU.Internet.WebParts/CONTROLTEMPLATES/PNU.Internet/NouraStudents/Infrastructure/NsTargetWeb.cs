...
{
    /// <summary>
    /// Resolves the web that hosts the Noura Students lists.
    ///
    /// All eleven lists live on ONE web - /ar/NouraStudents - regardless of which web
    ...
    /// </summary>
    public static class NsTargetWeb
    {
        /// <summary>Path of the web holding the content lists.</summary>
        public const string DefaultPath = "/ar/NouraStudents";
        ...
        private static SPWeb OpenPath(SPSite site, string path, bool allowFallback)
        {
            ...
            {
                NsLog.Write("NsTargetWeb.OpenFallback", ex);
            }
