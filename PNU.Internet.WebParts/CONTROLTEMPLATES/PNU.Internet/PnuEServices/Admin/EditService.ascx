...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditService.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.PnuEServices.Admin.EditService" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-floating mb-4">
                                ...
                                <asp:Image ID="sImage" runat="server" />
