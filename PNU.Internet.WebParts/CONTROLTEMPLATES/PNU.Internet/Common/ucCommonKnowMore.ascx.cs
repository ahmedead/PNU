...
{
    public partial class ucCommonKnowMore : UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (WebPartTitle == null || WebPartTitle == "")
                    WebPartTitle = SPFactory.GetPNUresResource("KnowMore"); //"تعرف أيضا علي";
        ...
        private void BindKnowMore()
        {
            try
            {
                ...
                {
                    using (SPWeb web = site.OpenWeb(PortalHelper.ParentLangSite))
                    {
