...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucCommonKnowMore.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.Common.ucCommonKnowMore" %>
