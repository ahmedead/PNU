...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucSiteKnowMore.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.Common.ucSiteKnowMore" %>
