...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucCollegeServices.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.Colleges.ucCollegeServices" %>
        ...
        <div class="container">
          <div class="d-flex align-items-start">
            <h1 class="title text-dark fw-bold px-2 border-start border-primary mb-4 mt-md-0 mt-4 me-md-4 flex-shrink-0">
                <asp:Literal runat="server" Text="<%$ Resources: PNUres, CollegeDepartments %>" /> 
