...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucCollegeSections.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.Colleges.Sections.ucCollegeSections" %>
                        ...
                        <ItemTemplate>
                            <div class="swiper-slide bg-transparent">
                                <div class="card border-0 mb-4 p-0 overflow-hidden also-know-card">
                                    ...
                                    <a href=<%# String.Format("Sections.aspx?SecCode={0}", Eval("Code")) %> " class="stretched-link text-decoration-none">
