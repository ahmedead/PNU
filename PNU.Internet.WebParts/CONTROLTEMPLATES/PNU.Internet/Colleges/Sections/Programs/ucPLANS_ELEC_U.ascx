                                    ...
                                    <asp:Repeater ID="rptCoursesU" runat="server" DataSource='<%# Eval("StudyPlan") %>'>
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <%--<td class="text-center"><%# Eval("SMRACAA_SEQNO") %></td>
                                                <td class="text-center"></td>
                                                <td class="text-center"></td>
                                                <td class="text-center"><%# Eval("SMRACAA_ATTR_CODE") %></td>
												
												<td class="text-center"><%# Eval("LAB") %></td>
                                                <td class="text-center"><%# Eval("OTH") %></td>
                                                <td class="text-center"><%# Eval("CREDIT") %></td>--%>
                                            </tr>
                                            <tr>
                                            </tr>
