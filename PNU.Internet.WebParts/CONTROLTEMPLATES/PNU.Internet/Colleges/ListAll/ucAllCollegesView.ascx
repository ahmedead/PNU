...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAllCollegesView.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.Colleges.ListAll.ucAllCollegesView" %>
                                ...
                                <ItemTemplate>
                                    <div class="col-md-6 col-xl-4 col-xxl-3">
                                        <div class="flip-card card item bg-transparent position-relative">
                                            <a href="<%# String.Format("{1}Faculties/Pages/FacultyMainPage.aspx?Source={0}", Eval("Code"),SPFactory.GetSiteURL()) %>" class="stretched-link "></a>
