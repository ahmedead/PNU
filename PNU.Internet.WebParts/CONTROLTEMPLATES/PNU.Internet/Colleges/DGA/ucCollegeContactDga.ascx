...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucCollegeContactDga.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.Colleges.DGA.ucCollegeContactDga" %>
