...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucCollegeProgramsDga.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.Colleges.DGA.ucCollegeProgramsDga" %>
...
<asp:PlaceHolder ID="phPrograms" runat="server">
    ...
    <div class="accordion accordion-flush" id="faculty-programsAccordion">
            ...
            <ItemTemplate>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-collapse collapse" id='<%# Eval("CollapseId") %>'
                        ...
                        data-bs-parent="#faculty-programsAccordion">
                                            ...
                                            <div class="card nav-card h-100">
                                                <div class="d-flex card-body flex-column gap-4">
                                                    <div class="icon-container">
                                                        <i class='hgi hgi-stroke <%# Eval("IconClass") %> fs-3'
                                                            aria-hidden="true"></i>
                                                    </div>
                                                    <div>
