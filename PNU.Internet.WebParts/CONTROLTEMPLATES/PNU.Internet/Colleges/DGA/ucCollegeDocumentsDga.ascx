...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucCollegeDocumentsDga.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.Colleges.DGA.ucCollegeDocumentsDga" %>
