...
{
    /// <summary>
    /// Resolves the web that hosts the University President Office lists.
    ...
    /// </summary>
    public static class UpoTargetWeb
    {
        ...
        private static SPWeb OpenPath(SPSite site, string path, bool allowFallback)
        {
            ...
            {
                UpoLog.Write("UpoTargetWeb.OpenFallback", ex);
            }
