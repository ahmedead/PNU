...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucUpoAdmin.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.AboutUniversity.UniversityPresidentOffice.ucUpoAdmin, $SharePoint.Project.AssemblyFullName$" %>

<section class="py-5 upo-admin">
    <div class="container">
