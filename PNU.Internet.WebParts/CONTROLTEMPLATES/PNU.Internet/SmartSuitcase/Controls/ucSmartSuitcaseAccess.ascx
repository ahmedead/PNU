...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucSmartSuitcaseAccess.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.SmartSuitcase.Controls.ucSmartSuitcaseAccess, $SharePoint.Project.AssemblyFullName$" %>

<section id="secAccess" runat="server" class="py-5" aria-labelledby="smart-suitcase-access-title">
    <div class="container">
        <asp:PlaceHolder ID="phHeading" runat="server">
            <h2 class="h3 mb-4" id="smart-suitcase-access-title"><asp:Literal ID="ltSectionTitle" runat="server" /></h2>
        </asp:PlaceHolder>
        <div class="row g-4">
            <asp:Repeater ID="rptAccess" runat="server">
                <ItemTemplate>
                    <div class='<%# Container.ItemIndex == 0 ? "col-12 col-lg-8" : "col-12 col-lg-4" %>'>
