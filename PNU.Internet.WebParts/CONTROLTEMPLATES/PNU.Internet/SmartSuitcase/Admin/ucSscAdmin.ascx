...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucSscAdmin.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.SmartSuitcase.Controls.ucSscAdmin, $SharePoint.Project.AssemblyFullName$" %>

<section class="py-5 ssc-admin">
    <div class="container">
