...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucEserviceBrowOld.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.EserviceList.ucEserviceBrowOld" %>
 ...
 <div class="services-catalog">
        <div class="jumbotron text-center">
            <div class="container mb-5" style="display:none">
                <div class="my-5">
                    <h1 class="display-4 pt-4 font-weight-bolder pb-4"> <asp:Literal ID="lit_eserviceguide" runat="server" Text="<%$Resources:PnuInternetResources, res_EservicesGuide%>"></asp:Literal>  </h1>
                    <p class="lead "> <asp:Literal ID="lit_eservicesearch" runat="server" Text="<%$Resources:PnuInternetResources, res_SearchService%>"></asp:Literal>  </p>
                </div>
                           ...
                           <div class="search">
                                <div class="card card-sm m-0 p-0 border-0  shadow-app">
                                    <div class="card-body row no-gutters align-items-center p-2 px-0">
                                        <div class="input-group align-items-center">
                                            ...
                                            <div class="col pl-0">
                                                <asp:TextBox ID="txtSearch" placeholder=" <%$Resources:PnuInternetResources, res_SearchServiceplaceholder%>"
                                            ...
                                            <div class="col-auto px-2">
                                                <span class="input-group-btn">
                                                    <asp:LinkButton ID="Search" BackColor="#024D4C"
                                                        ...
                                                        runat="server" Text="<%$Resources:PnuInternetResources, res_Search%>" OnClick="Search_Click1" />
                                                </span>
                                            </div>
                                ...
                                <div class="pb-5 mb-5">
                                    <p class="text-muted mt-3  text-left">
                                        <span class="mx-2">
                                            <asp:Literal ID="lit_MostUsedServices" runat="server" Text="<%$Resources:PnuInternetResources, res_MostUsedServices%>"></asp:Literal> 
                                        </span>
                    ...
                    <div  data-toggle="all" class="card card-sm m-0 p-0 border-0  shadow-app audience-card audience-selected ">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title mb-1"> 
                                <asp:Literal ID="lit_all" runat="server" Text="<%$Resources:PnuInternetResources, res_All%>"></asp:Literal>
                ...
                <div class="col-md-3 col-sm-6 col-xs-6  col-6">
                    <div  data-toggle="rptprod" class="card card-sm m-0 p-0 border-0  shadow-app audience-card">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title mb-1"> <asp:Literal ID="lit_students" runat="server" Text="<%$Resources:PnuInternetResources, res_Students%>"></asp:Literal>  </h5>
                            <p class="card-text">
                            <asp:Label ID="lblStNser" CssClass="card-text" runat="server"></asp:Label>
                            <asp:Literal ID="lit_service" runat="server" Text="<%$Resources:PnuInternetResources, res_Service%>"></asp:Literal> 
                            </p>
                ...
                <div class="col-md-3 col-sm-6 col-xs-6 col-6">
                    <div data-toggle="RepFMem" class="card card-sm m-0 p-0 border-0  shadow-app audience-card">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title mb-1"> <asp:Literal ID="lit_staff" runat="server" Text="<%$Resources:PnuInternetResources, res_Staff%>"></asp:Literal>  </h5>
                             <p class="card-text">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6 col-6">
                    <div data-toggle="RepVisitor" class="card card-sm m-0 p-0 border-0  shadow-app audience-card">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title mb-1"> <asp:Literal ID="lit_visitors" runat="server" Text="<%$Resources:PnuInternetResources, res_Visitors%>"></asp:Literal>  </h5>
                              <p class="card-text">
     ...
     <div class="container mb-5 pb-5 filter-services" data-toggle="rptprod" >
          <div class="bg-title m-3 mb-5">
                <h5><asp:Literal ID="lit_stdService" runat="server" Text="<%$Resources:PnuInternetResources, res_StudentsServices%>"></asp:Literal>  </h5>
            </div>
             ...
             <div class="" style="display:flex;flex-basis:33%;flex-direction:row;flex-wrap:wrap;">
                    ...
                    <div class="service-card">
                        ...
                        <div class="service-btn-wrapper">
                            <a target="_blank" href="service-details.aspx?eti=<%#DataBinder.Eval(Container.DataItem,"ID") %>" class="serv-btn  serv-link"> <asp:Literal ID="lit_serviceDetails" runat="server" Text="<%$Resources:PnuInternetResources, res_ServiceDetails%>"></asp:Literal> </a>
                            <a target="_blank" href="<%#DataBinder.Eval(Container.DataItem,"URL") %>  " class="serv-btn "> <asp:Literal ID="lit_startService" runat="server" Text="<%$Resources:PnuInternetResources, res_StartService%>"></asp:Literal> </a>
                        </div>
                    </div>
                </div>
     ...
     <div class="container mb-5 pb-5 filter-services" data-toggle="RepFMem" style="margin-top:-100px;" >
         <div class="bg-title m-3 mb-5">
                <h5> <asp:Literal ID="lit_staffservice" runat="server" Text="<%$Resources:PnuInternetResources, res_StaffServices%>"></asp:Literal>  </h5>
         ...
         <ItemTemplate>
             <div class="" style="display:flex;flex-basis:33%;flex-direction:row;flex-wrap:wrap;">
                    ...
                    <div class="service-card">
                        ...
                        <div class="service-btn-wrapper">
                            <a target="_blank" href="service-details.aspx?eti=<%#DataBinder.Eval(Container.DataItem,"ID") %>" class="serv-btn  serv-link"> <asp:Literal ID="lit_srvDetails" runat="server" Text="<%$Resources:PnuInternetResources, res_ServiceDetails%>"></asp:Literal>  </a>
                            <a target="_blank" href="<%#DataBinder.Eval(Container.DataItem,"URL") %>  " class="serv-btn "> <asp:Literal ID="Literal1" runat="server" Text="<%$Resources:PnuInternetResources, res_StartService%>"></asp:Literal> </a>
                        </div>
                    </div>
                </div>
     ...
     <!-- End of Faculty -->
         ...
         <div class="bg-title m-3 mb-5">
                <h5><asp:Literal ID="lit_visitorsSrv" runat="server" Text="<%$Resources:PnuInternetResources, res_VisitorsServices%>"></asp:Literal>  </h5>
