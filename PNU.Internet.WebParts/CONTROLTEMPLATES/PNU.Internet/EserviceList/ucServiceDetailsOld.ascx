...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucServiceDetailsOld.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.EserviceList.ucServiceDetailsOld" %>
        ...
        <div class="container  my-5 py-5 ">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 mb-5">
                    <%--<button type="button" class="btn btn-lg btn-block p-3 main-btn"> إبدأ الخدمة </button>--%>
                ...
                <div class="row mt-3 ">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="card card-sm m-0 p-4 py-4  border-0 rounded-pill shadow-app  card-info mb-5 d-flex flex-column">
                            <img  class="w-25 mt-3 mb-3" src="assets/imgs/guide.svg" title="">
                            ...
                            <div class="service-btn-wrapper mt-3">
                               ...
                               <%-- <a title="download" href="http://portal.pnudstst.edu.sa/Lists/EservicesList/AllItems.aspx" runat="server" class="btn btn-md btn-block py-2 main-btn" target="_blank"></a>
                                <button id="btnUserMan" value="http://portal.pnudstst.edu.sa/Lists/EservicesList/AllItems.aspx"  target="_blank" runat="server"  class="btn btn-md btn-block py-2 main-btn"> تحميل دليل الاستخدام</button>--%>
                            </div>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="align-self-center">
                                        ...
                                        <p class="mt-2 mx-2 mb-0">
                                            اضغط لتحميل الشروط والاحكام
                                        </p>
                                    </div>
                                </div>
                                
                                    <button target="_blank" class="btn btn-md  py-2 px-4 main-btn" style="height: fit-content;" onclick="window.open('/ar/SECURITYCYBER/Pages/Privacy-Policy.aspx');">تحميل </button>
