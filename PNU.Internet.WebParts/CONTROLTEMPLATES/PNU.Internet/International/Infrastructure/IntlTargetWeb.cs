...
{
    /// <summary>
    /// Resolves the web that hosts the International Students lists.
    ///
    /// All ten lists live on ONE web - /ar/International - regardless of which web
    /// the page is rendered from, so the Arabic and English pages share a single set of
    /// bilingual items and editors have one place to manage them.
    ///
    /// The caller ALWAYS disposes the returned SPWeb.
    /// </summary>
    public static class IntlTargetWeb
    {
        /// <summary>Path of the web holding the content lists.</summary>
        public const string DefaultPath = "/ar/International";
        ...
        /// <summary>
        /// Farm-wide override of <see cref="DefaultPath"/>. Leave alone unless the lists
        /// are moved; a leading "/" is treated as relative to the site collection root.
        /// </summary>
        ...
        /// <summary>
        /// Opens the web holding the lists. Falls back to the current context web when
        ...
        private static SPWeb OpenPath(SPSite site, string path, bool allowFallback)
        {
            ...
            {
                IntlLog.Write("IntlTargetWeb.OpenFallback", ex);
            }

            return null;
        }

        /// <summary>Id of the web holding the lists, or Guid.Empty when unavailable.</summary>
