...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucIntlAdmin.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.International.Controls.ucIntlAdmin, $SharePoint.Project.AssemblyFullName$" %>

<section class="py-5 intl-admin">
    <div class="container">
