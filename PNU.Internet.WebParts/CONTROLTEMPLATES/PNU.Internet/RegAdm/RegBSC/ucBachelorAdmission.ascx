...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucBachelorAdmission.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.RegAdm.RegBSC.ucBachelorAdmission" %>
...
<main id="main-content" class="dga-main-body" tabindex="-1">
    ...
    <!-- Overview -->
    <section class="py-5" data-aos="fade-up" aria-labelledby="bachelor-overview-title">
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-12 col-md-12 col-lg-12">
                    <h2 id="bachelor-overview-title" class="mb-4"><asp:Literal ID="litOverviewTitle" runat="server" /></h2>
