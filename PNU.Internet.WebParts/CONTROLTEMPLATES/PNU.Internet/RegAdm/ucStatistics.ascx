...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucStatistics.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.RegAdm.ucStatistics" %>
        ...
        <div class="container mb-4">
            <div class="row">
                <asp:Repeater ID="rptStatistics" runat="server">
                    <ItemTemplate>
                        <div class="col-lg-4 col-md-6  mb-lg-0 mb-5 text-center">
