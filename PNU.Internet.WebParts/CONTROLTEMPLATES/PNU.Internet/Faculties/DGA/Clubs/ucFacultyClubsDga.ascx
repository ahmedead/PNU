...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucFacultyClubsDga.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.Faculties.DGA.ucFacultyClubsDga" %>
                                                        ...
                                                        <asp:Repeater ID="rptTableRows" runat="server">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    <td><%# Eval("Col1") %></td>
                                                                    <td><%# Eval("Col2") %></td>
                                                                    <asp:Panel runat="server" Visible='<%# Eval("HasCol3") %>'>
                                                                        <td><%# Eval("Col3") %></td>
                                                                    </asp:Panel>
                                                                </tr>
                                                            </ItemTemplate>
