...
namespace PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.Faculties.DGA
{
    ...
    /// </summary>
    public partial class ucFacultyClubsDga : UserControl
    {
        ...
        {
            //ltrHeading.Text = IsArabic ? "الأندية الطلابية في الكلية" : "Student Clubs in the Faculty";
            //ltrIntro.Text = IsArabic ? "تعرّف على الأندية الطلابية التعليمية والنادي الرياضي في الكلية." : "Learn about the educational student clubs and the sports club in the faculty.";
        }

        private void BindItems(SPWeb web)
        {
            SPList list = web.Lists.TryGetList(ClubsProvisioner.ItemsListName);
            ...
            foreach (SPListItem it in sorted.OrderBy(x => SafeDouble(x, "SortOrder")))
            {
                ...
                dtos.Add(new ItemDto
                {
                    ...
                    HeadingId = "faculty-clubsAccordionHeading" + idx,
                    CollapseId = "faculty-clubsAccordionCollapse" + idx,
            ...
            Dictionary<string, List<ImageDto>> imagesByKey)
        {
            ...
            SPList list = web.Lists.TryGetList(ClubsProvisioner.SectionsListName);
        ...
        private Dictionary<string, List<SubItemDto>> LoadSubItems(SPWeb web)
        {
            ...
            SPList list = web.Lists.TryGetList(ClubsProvisioner.SubItemsListName);
            if (list == null) return map;
        ...
        private Dictionary<string, List<TableRowDto>> LoadTableRows(SPWeb web)
        {
            ...
            SPList list = web.Lists.TryGetList(ClubsProvisioner.TableListName);
            if (list == null) return map;
        ...
        private Dictionary<string, List<ImageDto>> LoadImages(SPWeb web)
        {
            ...
            SPList list = web.Lists.TryGetList(ClubsProvisioner.ImagesListName);
            if (list == null) return map;
