...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucFacultyStudentServicesDga.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.Faculties.DGA.ucFacultyStudentServicesDga" %>
