...
namespace PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.Faculties.DGA
{
    ...
    public partial class ucFacultyOrgStructureDga : UserControl
    {
        ...
        {
            //ltrHeading.Text = IsArabic ? "الهيكل التنظيمي للكلية" : "Faculty Organizational Structure";
            //ltrIntro.Text = IsArabic
            //    ? "يعرض الهيكل التنظيمي موقع الوحدات والارتباطات الإدارية داخل الكلية."
            //    : "The organizational structure shows the units and administrative relationships within the faculty.";
        }
        ...
        private void BindItems(SPWeb web)
        {
            ...
            foreach (SPListItem it in sorted.OrderBy(x => SafeDouble(x, "SortOrder")))
            {
                ...
                dtos.Add(new ItemDto
                {
                    ...
                    HeadingId = "faculty-org-structureAccordionHeading" + idx,
                    CollapseId = "faculty-org-structureAccordionCollapse" + idx,
