...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucSiteMap.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.DGANewDesign.ucSiteMap" %>
    ...
    <div class="container page-padding">
        ...
        <ul class="text-primary">
            <asp:Repeater ID="rptLevel1" runat="server" OnItemDataBound="rptLevel1_ItemDataBound">
                <ItemTemplate>
                    <li class="mt-3">
                        <%-- Level 1: span (no URL) or link (has URL, no children) --%>
