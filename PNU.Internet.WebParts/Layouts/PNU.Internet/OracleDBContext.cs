...
namespace PNU.Internet.WebParts.Layouts.PNU.Internet
{
    public static class OracleDBContext
    {
        ...
        public static List<CollegeDeptsDto> GetCollegeDeptsFromOracleDB()
        {
            ...
            {
                Publics.WriteToLog(HttpContext.Current.Request.Url.ToString(),"OracleDBContext - GetCollegeDeptsFromOracleDB", ex.Message);
                return null;
            }
        ...
        public static List<CourseDto> GetInstCoursesFromOracleDB(string email)
        {
            try
            {
                email = email.ToLower();
                ...
                conn.Open();
                OracleCommand cmd = conn.CreateCommand();
                var MemberCourseViewName = Helper.GetCustomFormsGlobalResourceValue("PnuInternetResources", "res_MemberCoursesView");
                cmd.CommandText = @"SELECT inst.scbcrse_title ,inst.scbcrse_subj_code as code , inst.scbcrse_crse_numb as numb , 
                                inst.scbcrse_subj_code||inst.scbcrse_crse_numb as scbcrse_subj_code ,
                                inst.registered_count,inst.ssbsect_crn ,inst.day,
                                inst.ssrmeet_begin_time ,inst.scrlevl_levl_code ,  inst.level_desc,
                                inst.PNU_MAIL instructor_pnu_email ,
                                inst.ssrmeet_end_time  FROM " + MemberCourseViewName + "  inst  WHERE LOWER(inst.PNU_MAIL) = N'" + email + "'";
        ...
        public static List<CourseDto> GetInstCoursesFromSQLDB(string email)
        {
            ...
            {
                email = email.ToLower();
                var oradb = SQLFactory.GetConnectionString("New_PNU_Portal_Cust_DB");
        ...
        public static void SaveInstructorCourses_ENDataToDB()
        {
            try
            {
        ...
        public static void SaveGadeerCoursesDataToDB()
        {
            try
            {
                ...
                SQLFactory.SetConn(sqldb);
                //List<tblMemberCourses> _AllData = SQLFactory.ReadDataFromTable<tblMemberCourses>("tblMemberCourses", " APICALL = N'NO'","","TOP 100");
                ...
                while (_AllDataDistinct.Count > 0 && _AllDataDistinct != null)
                {
                    ...
                    {
                        Publics.WriteToLog(HttpContext.Current.Request.Url.ToString(), "OracleDBContext - SaveGadeerCoursesDataToDB", ex.Message);
                    }
        ...
        public static void SaveGadeerCoursesDataToDB_EN()
        {
            try
            {
                ...
                while (_AllDataDistinct.Count > 0 && _AllDataDistinct != null)
                {
                    ...
                    {
                        Publics.WriteToLog(HttpContext.Current.Request.Url.ToString(), "OracleDBContext - SaveGadeerCoursesDataToDB_EN", ex.Message);
                    }
        ...
        public static string GetBannerConfigurationValue()
        {
            try
            {
                return SQLFactory.GetConnectionString("BannerConn");
        ...
        public static string GetStatisticsViewConfigurationValue()
        {
            try
            {
                return SQLFactory.GetConnectionString("StatisticsConn");
        ...
        public static string GetSQLDBConnection()
        {
            try
            {
                return SQLFactory.GetConnectionString("New_PNU_Portal_Cust_DB");
                //return ConfigurationManager.AppSettings["BannerConn"];
        ...
        public static string GetGrpConfigurationValue()
        {
            try
            {
                return SQLFactory.GetConnectionString("GrpConn");
