...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucFacilitesDetails.ascx.cs" Inherits="PNU.Internet.WebParts.CONTROLTEMPLATES.PNU.Internet.Centers.ucFacilitesDetails" %>
        ...
        <section class=" my-5 p-5 bg-semi-light position-relative" style="display:none">
            <div class="container my-5">
                <h1 class="title text-dark fw-bold px-2 border-start border-primary mb-4 mt-md-0 mt-4"> <asp:Literal ID="lit_TrainServices" runat="server" Text="<%$Resources:PnuInternetResources, res_TrainServices%>"></asp:Literal>  
                        ...
                        <ItemTemplate>
                            ...
                            <div class="swiper-slide h-auto">
                                ...
                                <div class="card border-0 shadow-sm h-100">
                                    <a href="<%# String.Format("FacilityServiceDetails.aspx?ServiceId={0}", Eval("ID")) %> ">
