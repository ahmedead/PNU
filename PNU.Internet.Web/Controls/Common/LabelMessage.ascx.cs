...
namespace PNU.Internet.Web.Controls.Common
{
    public partial class LabelMessage : System.Web.UI.UserControl
    {
        ...
        {
            this.ShowMessage(message, "alert alert-danger alert-dismissible fade show", "error_icon", clearMessages);
        }
        ...
        {
            this.ShowMessage(message, "alert alert-warning alert-dismissible fade show", "info_icon", clearMessages);
        }
        ...
        {
            this.ShowMessage(message, "alert alert-success alert-dismissible fade show", "true_icon", clearMessages);
            this.ShowMessage(message, "alert alert-success alert-dismissible fade show", "true_icon", clearMessages);
        }

        public void ShowSuccess(bool clearMessages = ClearMessageDefault)
        {
            this.ShowMessage(Resources.Messages.CompleteSuccessfully, "alert alert-success alert-dismissible fade show", "true_icon", clearMessages);
        }
        ...
        {
            this.ShowMessage(message, "alert alert-warning alert-dismissible fade show", "alert_icon", clearMessages);
        }
