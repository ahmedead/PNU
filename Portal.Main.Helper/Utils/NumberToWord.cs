// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NumberToWord.cs" company="Sliding Stones">
...
namespace Portal.Main.Helper.Utils
{
    ...
    public class NumberToWord
    {
        ...
        {
            this.InitializeClass(number, currency, string.Empty, "only.", "فقط", "لا غير.");
        }
        ...
        private static readonly string[] EnglishGroup =
            {
                ...
                "Unvigintillion", "Duovigintillion", "10^72", "10^75", "10^78", 
                "10^81", "10^84", "10^87", "Vigintinonillion", "10^93", 
                "10^96", "Duotrigintillion", "Trestrigintillion"
            };
        ...
        private static readonly string[] ArabicOnes =
            {
                string.Empty, "واحد", "اثنان", "ثلاثة", "أربعة", "خمسة", "ستة", 
        ...
        private static readonly string[] ArabicFeminineOnes =
            {
                string.Empty, "إحدى", "اثنتان", "ثلاث", "أربع", "خمس", 
                "ست", "سبع", "ثمان", "تسع", "عشر", "إحدى عشرة", 
                "اثنتا عشرة", "ثلاث عشرة", "أربع عشرة", "خمس عشرة", 
        ...
        private static readonly string[] ArabicHundreds =
            {
                string.Empty, "مائة", "مئتان", "ثلاثمائة", "أربعمائة", 
        ...
        private static readonly string[] ArabicAppendedTwos =
            {
                "مئتا", "ألفا", "مليونا", "مليارا", "تريليونا", 
        ...
        private static readonly string[] ArabicAppendedGroup =
            {
                string.Empty, "ألفاً", "مليوناً", "ملياراً", 
                "تريليوناً", "كوادريليوناً", "كوينتليوناً", 
                "سكستيليوناً"
            };
        ...
        private static readonly string[] ArabicPluralGroups =
            {
                string.Empty, "آلاف", "ملايين", "مليارات", "تريليونات", 
            ...
            if (tens > 0)
            {
                if (tens < 20)
                {
                    ...
                    if (tens == 2 && hundreds == 0 && groupLevel > 0)
                    {
                        ...
                        {
                            retVal = $"{ArabicAppendedTwos[groupLevel]}"; // في حالة الإضافة
                        }
                        else
                        {
