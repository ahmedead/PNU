    ...
    public partial class Search_Criteria_WPUserControl : UserControl
    {
        ...
        protected SPListItemCollection LoadData()
        {
            ...
            if(cal.SelectedDate != null)
                qryParam.Add("<Geq><FieldRef Name='FromDate' /><Value IncludeTimeValue='TRUE' Type='DateTime'>" + SPUtility.CreateISO8601DateTimeFromSystemDateTime(cal.SelectedDate) + "</Value></Geq>");


            return Helper.LoadListDynamicByCML(SPContext.Current.Web.Url, listname, qryParam,null);
        }
