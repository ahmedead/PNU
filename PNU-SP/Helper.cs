...
namespace PNU_SP
{
    ...
    {
        public static SPListItemCollection LoadListDynamicByCML(string SiteURL, string ListName, ArrayList qryParams,int? rowLimit)
        {
            ...
            try
            {
                ...
                if (rowLimit != null)
                {
                 ...
                 "Ascending='False' /></OrderBy><RowLimit> " + rowLimit + " </ RowLimit >" + whereQry;
                }
                else
                {
                    qry.Query = "<OrderBy><FieldRef Name='ID' " +
